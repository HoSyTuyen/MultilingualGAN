...
def oct_conv1x1(in_planes, out_planes,alpha_in=0.25, alpha_out=0.25, kernel_size=1, stride=1, padding =3, type='normal'):
    """1x1 convolution with padding"""
    return OctConv(in_planes, out_planes, alpha_in=alpha_in, alpha_out=alpha_out, kernel_size=kernel_size, stride=stride, padding=padding, type=type)
def norm_conv1x1(in_planes, out_planes,alpha_in=0.25, alpha_out=0.25, kernel_size=1, stride=1, padding =3, type=None):
    """3x3 convolution with padding"""
    return nn.Conv2d(in_planes, out_planes, kernel_size=kernel_size, stride=stride, padding=padding, bias=False)
...
class OctConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0,
                 alpha_in=0.5, alpha_out=0.5, type='normal'):
